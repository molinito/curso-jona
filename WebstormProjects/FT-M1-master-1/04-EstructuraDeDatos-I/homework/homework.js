...
// for (let i = 0; i < 10; i++) {
 // console.log(`factorial ${i}: ${nFactorial(i)}`)
// }

function nFibonacci(n) {

  // secuencia de fibonacci : 0, 1, 1, 2, 3, 5, 8, 13, 21, 3455, 89, 144,...
  //retorna el enésimo número de la serie
  // nFibonacci(0) // 0 // el elemento cero es 0
...
//  for (let i = 0; i < 10; i++) {
 // console.log(`fibo ${i}: ${nFibonacci(i)} `)
//}
